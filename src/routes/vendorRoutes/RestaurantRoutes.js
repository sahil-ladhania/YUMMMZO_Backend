...
router.post('/restaurants' , validateRequest(createRestaurantValidation) , createRestaurant); // If Owner tries to create a new restaurant -> createRestaurant will start executing.
router.put('/restaurants/:restaurantId' , validateRequest(updateRestaurantValidation) , updateRestaurant); // If Owner tries to update an existing restaurant -> updateRestaurant will start executing.
