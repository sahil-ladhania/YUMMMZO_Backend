...
import { createMenu, deleteMenu, getAllMenuItems, getAllMenus, getAMenu, getAMenuItem, updateMenu } from '../../controllers/vendorControllers/menuManagement/MenuControllers.js';
...
router.get('/restaurants/:restaurantId/menu/:menuId' , getAMenu);
router.get('/restaurants/:restaurantId/menu/:menuId/menuItems' , getAllMenuItems); 
router.get('/restaurants/:restaurantId/menu/:menuId/menuItems/:menuItemId' , getAMenuItem);
router.put('/restaurants/:restaurantId/menu/:menuId' , updateMenu);
router.delete('/restaurants/:restaurantId/menu/:menuId' , deleteMenu);
